...
export default function Navbar() {
  ...
  return (
    <>
      {/* Default navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-[75px] h-[110px]">
        <Link href="/">
          <Image
      ...
      <button
        ...
        className={`fixed top-[30px] right-[75px] w-[50px] h-[50px] flex flex-col items-center justify-center gap-[6px] z-[110] transition-all duration-300 ${!open ? 'rounded-full bg-[#d7432a]' : ''}`}
      ...
      {open && (
        <div className="fixed inset-0 z-[100] overflow-hidden">
          ...
          {/* Menu content */}
          <div
            className="relative z-10 h-full flex flex-col px-[75px] pt-[30px]"
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-[15px]">
              <Link href="/work" onClick={() => setOpen(false)}
                className="font-bel font-semibold text-[85px] leading-none text-[#f9ce6a] hover:opacity-80 transition-opacity">
                Our Work
              </Link>
              <Link href="/workshops-audits" onClick={() => setOpen(false)}
                className="font-bel font-semibold text-[85px] leading-none text-[#380102] hover:opacity-80 transition-opacity">
                Workshops &amp; Audits
              </Link>
